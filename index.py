...
# Create directories for screenshots if they don't already exist
full_screenshots_dir = 'temps/Full_Screenshots'
cropped_screenshots_dir = 'temps/Cropped_Screenshots'
# no_bg_screenshots_dir = 'No-Background_Screenshots'
# os.makedirs(full_screenshots_dir, exist_ok=True)
# os.makedirs(cropped_screenshots_dir, exist_ok=True)

# Open a TagUI script file for writing
